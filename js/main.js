$(document).ready(function(){
	$('.catal__slider').slick({
		...
		dots: false, // включает точки внизу слайдера
		adaptiveHeight: false, // автоматическая адаптивная высота слайдера, подстраивается под разные размеры
		slidesToShow: 3, // кол-во файлов, которые мы хотим отобразить
		...
		autoplaySpeed: 2000, // скорость автопроигрование
		pauseOnFocus: false, // остановка автороигрования / клик
		pauseOnHover: false, // остановка автороигрования
